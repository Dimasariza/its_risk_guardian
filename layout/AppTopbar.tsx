  ...
  return (
    <div className="layout-topbar">
      ...
      <div className={classNames('flex w-8 h-full align-items-center', {
        ...
        <img src={`${process.env.PUBLIC_URL}/layout/images/ITS.png`} width="50px" height={'50px'} alt="logo" className='mx-3' />
        <img src={`${process.env.PUBLIC_URL}/layout/images/DMOM.png`} width="140px" height={'80px'} alt="logo" className='mx-3'/>
      </div>
