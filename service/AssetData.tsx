export const AssetsService = {
  async getAllAssets() {
    ...
    const [{ data: companies }, { data: units }, { data: equipment }, { data: component }] = await Promise.all([fetchCompanies.json(), fetchUnits.json(), fetchEquipment.json(), fetchComponent.json()]);
