...
import IPOFPlan from "@/types/IPOFPlan";
import * as formulajs from '@formulajs/formulajs'

export const calcPRDPOFPlan = (generalData: IGeneralData, pofRBI: any, from: string = "pofod") => {
    const {
    ...
    const planDateObj: Date | any = new Date(plan_planDate);
