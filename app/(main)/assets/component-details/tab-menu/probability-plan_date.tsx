    ...
    return (
        <>
            <div className="flex flex-column gap-2">
                ...
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="4"/>
                ...
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="0.00347"/>
                ...
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="4.516823"/>
                <label htmlFor="username">Beta Thin 2</label>
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="4.568076"/>
                ...
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="0.019323"/>
                <label htmlFor="username">DF for thinning</label>
                <InputText id="username" aria-describedby="username-help" className="p-inputtext-sm" value="0.017"/>
            </div>
