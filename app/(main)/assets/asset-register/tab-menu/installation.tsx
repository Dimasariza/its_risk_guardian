  ...
  return (
    <>
      ...
      <section className="grid gap-2 mx-2">
        ...
        <label htmlFor="diameter" className="col-6">
          Diameter
        </label>
